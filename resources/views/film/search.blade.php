...
@section('content')
        ...
        <div class="search-wrapper" style="margin-top: 56px;">
            <div class="container container--add" style="padding-top: 15px">
                <form id="search-form" method="post" class="search" action="/phim/tim-kiem">
                    {{ csrf_field() }}
                    <input type="text" class="search__field" placeholder="Search Film......" name="keyword" id="txtKeyword" required>
        ...
        <section class="container">
            ...
            <h2 id='target' class="page-heading heading--outcontainer">Result: {{ $keyword }}</h2>
